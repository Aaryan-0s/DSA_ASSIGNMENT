    ...
    SubsetFinder(int realArrLen, int[] a) {
        ...
        for (int i = 0; i < a.length; i++) {
            ...
            for (int j = 0; j < a.length; j++) {
                ...
                //If both arrays are equal, push should be changed to false. 
                if (a[i] == a[j]) {
                    push = false;
                    break;
                } 
                //If both arrays are  not equal, push should be changed to true. 
                else if (a[i] != a[j]) {
                    push = true;
                }
            }
            //Add the element to the array if push is true. 
            if (push) {
        ...
        //creating a variable to hold the array's length 
